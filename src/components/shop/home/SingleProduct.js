                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3 z-10">
                         <div
                          ...
                          } cursor-pointer p-2 rounded-full bg-white/80 hover:bg-white shadow-sm backdrop-blur-sm transition-all duration-200`}
                        >
                          <svg
                        ...
                        <div
                          ...
                          className={`${
                            !isWish(item._id, wList) && "hidden"
                          } cursor-pointer p-2 rounded-full bg-red-50 hover:bg-red-100 shadow-sm transition-all duration-200`}
                        >
                          <svg
